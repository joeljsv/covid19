...
class _AssmentScreenState extends State<AssmentScreen> {
  final _questions = const [
    {
      'questionText':
          'Do you have a fever or respiratorysymptoms? \neg cough, sore throat,shortness of breath',
      'answers': [
        {'text': 'Yes', 'score': 10},
        {'text': 'No', 'score': 0},
      ],
    ...
    {
      'questionText':
          'Have you had close contact* in the last 14 days with a personwho has tested positive for COVID-19?',
      'answers': [
        {'text': 'Yes', 'score': 20},
        {'text': 'No', 'score': 0},
      ],
    ...
    {
      'questionText':
          'Are you a healthcare worker with both fever (>37.5) and respiratorysymptoms?',
      'answers': [
        {'text': 'Yes', 'score': 40},
        {'text': 'No', 'score': 0},
      ],
